...
import { Friend, Colleague, SecureFriendContact, FriendPartial, EventPass, IntersectionOfFriendAndColleague } from "./myTypes";
...
function secureFindFriends(
  ...
  ): IntersectionOfFriendAndColleague[] {
    let result: IntersectionOfFriendAndColleague[] = []
